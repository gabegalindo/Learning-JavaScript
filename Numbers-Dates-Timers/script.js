...
const account1 = {
  ...
  movementsDates: [
    ...
    '2024-01-18T14:11:59.604Z',
    '2024-01-20T17:01:17.194Z',
    '2024-01-21T23:36:17.929Z',
...
btnLogin.addEventListener('click', function (e) {
  ...
  if (currentAccount?.pin === +inputLoginPin.value) {
    ...
    labelDate.textContent = new Intl.DateTimeFormat('ar-LB', options).format(
      now
    );
...
console.log(2374650927349852739458723945729348569230480239485n);
console.log(BigInt(2374650927349852739458725));

console.log(10000n + 10000n);

console.log(
  9832745092837459283749527349852739485723984752829347592834759238475n +
    100000000n
);

const huge = 2930250349852039485209348502934853n;
const num = 23;
...
// console.log(new Date('Jan 16 2024 16:34:35'));
...
/////////////////////////////////////////////////
/* 174 Internationalizing numbers
